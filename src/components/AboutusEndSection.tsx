...
interface TransformHealthcareProps {
  onContactClick?: () => void;
  onDemoClick?: () => void;
}
            ...
            <div className="relative bg-white p-8 sm:p-12 lg:p-16 text-center border-2 border-orange-200 rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center px-4 sm:px-0">
                  <div className="w-full flex flex-row sm:w-auto bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white text-base sm:text-lg px-8 sm:px-10 py-3 sm:py-3 rounded-full shadow-2xl transform transition-all duration-300 hover:scale-105 border-0">
                    <p>Contact Our Team</p>
                    <ArrowRight className="ml-2 sm:ml-3 w-5 sm:w-6 h-5 sm:h-6 relative top-1" />
                  </div>
                  <button  className="w-full sm:w-auto text-base sm:text-lg px-8 sm:px-10 py-3 sm:py-3 rounded-full border-2 border-orange-500 text-orange-600 hover:bg-orange-500 hover:text-white shadow-lg transform transition-all duration-300 hover:scale-105">
                    Schedule a Demo
                  </button>
                </div>
              </div>
